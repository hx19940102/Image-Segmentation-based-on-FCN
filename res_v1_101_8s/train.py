...
res_101_8s_parameters_dir = '/home/kris/PycharmProjects/eecs545/res_v1_101_8s/res_v1_101_8s.ckpt'
res_parameters_dir = '/home/kris/PycharmProjects/eecs545/resnet_v1_101.ckpt'
...
logits, res_variables = model.res_101_fcn_8s(images, num_classes, is_training=False)
...
with tf.Session() as sess:
    ...
    saver.restore(sess, res_101_8s_parameters_dir)
    ...
    for i in range(training_rounds):
        ...
        if i % 299 == 0:
            saver.save(sess, res_101_8s_parameters_dir)
    coord.request_stop()
    coord.join(threads)
