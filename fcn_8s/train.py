...
logits, fcn_16s_variables = model.fcn_8s(images, num_classes, is_training=True)
...
init = slim.assign_from_checkpoint_fn(fcn16s_parameters_dir, fcn_16s_variables)
...
with tf.Session() as sess:
    ...
    for i in range(training_rounds):
        ...
        if i % 199 == 0:
            saver.save(sess, fcn8s_parameters_dir)
    coord.request_stop()
    coord.join(threads)
