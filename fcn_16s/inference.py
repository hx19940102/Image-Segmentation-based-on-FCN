...
_G_MEAN = 116.78
_B_MEAN = 103.94
filename = '/home/kris/PycharmProjects/eecs545/img3.jpg'
...
logits, vgg_variables = model.fcn_16s(resized_image, num_classes, is_training=False)
...
with tf.Session() as sess:
    ...
    cv2.imshow('img', img)
    cv2.imshow('res', res)
    cv2.imwrite('/home/kris/PycharmProjects/eecs545/fcn_16s/res.jpg', res)
    cv2.waitKey(0)
